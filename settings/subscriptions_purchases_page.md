...
### Заголовок страницы
- **Заголовок**: Текст "Subscriptions/Purchases"
...
- **Кнопка управления**: Кнопка "Manage" для перехода в нативный магазин приложений
...
- **Кнопка восстановления**: Кнопка "Restore Purchases" для восстановления предыдущих покупок
...
4. Пользователь может нажать кнопку "Manage" для управления подпиской

### Сценарий управления подпиской
1. Пользователь нажимает кнопку "Manage" рядом с подпиской
...
3. Пользователь может нажать кнопку "Manage" для управления покупкой

### Сценарий управления покупкой
1. Пользователь нажимает кнопку "Manage" рядом с покупкой
...
1. Пользователь нажимает кнопку "Restore Purchases"
