...
## Назначение экрана
Страница заметок служит для ведения дневника лечения элайнерами. Позволяет пользователю записывать наблюдения, проблемы, прогресс и вопросы к врачу, связанные с процессом лечения. Обеспечивает систематизацию и анализ личных записей о ходе ортодонтического лечения.
...
- **Индикатор категории**: иконка или метка, указывающая на категорию заметки
- **Время создания**: отображение времени создания заметки
- **Превью текста**: сокращенный текст заметки с возможностью развернуть
- **Кнопки управления**: иконки редактирования и удаления для каждой заметки
