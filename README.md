...
#### [Страницы настроек](settings_pages.md)
...
```
Авторизация → Онбординг → Настройки → Главная страница
     ↓              ↓           ↓           ↓
Регистрация    Настройки    Главная    Календарь
     ↓              ↓           ↓           ↓
  Главная       Главная    Статистика   Заметки
     ↓              ↓           ↓           ↓
...
*Документация подготовлена для дизайнера мобильного приложения Elainira. Каждый документ содержит детальное описание страницы с учетом специфики отслеживания элайнеров и ортодонтического лечения.*
